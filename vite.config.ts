...
const pwaPlugin = VitePWA({
  ...
  manifest: {
    ...
    shortcuts: [
      {
        name: "Get Help Now",
        short_name: "Crisis Help",
        description: "Access crisis resources immediately",
        url: "/triage",
        icons: [{ src: "/icons/icon-96x96.png", sizes: "96x96" }],
      },
      {
        name: "Find a Therapist",
        short_name: "Find Therapist",
        description: "Search for licensed therapists near you",
        url: "/find-therapist",
        icons: [{ src: "/icons/icon-96x96.png", sizes: "96x96" }],
      },
    ],
  ...
  workbox: {
    ...
    runtimeCaching: [
      {
        urlPattern: /^\/api\/trpc\/(triage|providers|crisis)/,
