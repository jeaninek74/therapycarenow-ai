...
const DEMO_STEPS = [
  ...
  },
  {
    ...
    description: "Our AI assistant helps you navigate mental health resources, understand your options, and find the right support — with clear disclaimers that it's not a substitute for professional care.",
    icon: Brain,
  ...
  },
  {
    ...
    demoContent: {
      ...
      features: [
        ...
        { label: "AI Moderation Gateway", desc: "All AI inputs screened before processing" },
